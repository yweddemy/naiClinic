function set_coo(city){alert(city);$("#city_cur").load('../aj.php',{city:city})};var jquery_blockui_params={"cart_url":"https:\/\/unilik.ua\/checkout\/","i18n_view_cart":"Checkout"};/*!
